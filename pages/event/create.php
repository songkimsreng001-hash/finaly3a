...
if (isset($_POST['submit'])) {
    ...
    if ($title === '') $titleErr = 'Please enter title';
    if ($desc === '')  $descErr  = 'Please enter description';
    if ($loc === '')   $locErr   = 'Please enter location';
    if ($date === '')  $dateErr  = 'Please select date';
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <div class="small text-muted mt-2">
                            Click image to upload (JPG, JPEG, PNG — max 500KB)
                        </div>
                    </div>
